...
import com.noop.study.springboot.config.auth.dto.OAuthAttributes;
import com.noop.study.springboot.config.auth.dto.SessionUser;
import com.noop.study.springboot.domain.user.User;
import com.noop.study.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // getUserNameAttributeName() -> OAuth2 로그인 진행시 키가 되는 필드값을 나타낸다.
